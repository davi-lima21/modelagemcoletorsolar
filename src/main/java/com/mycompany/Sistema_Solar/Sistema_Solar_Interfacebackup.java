 ...
 * tempo.
 */
public class Sistema_Solar_Interfacebackup extends javax.swing.JFrame {
     ...
     */
    public Sistema_Solar_Interfacebackup() {
        initComponents();
...
// painel_de_exibicao.repaint();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sistema_Solar_Interfacebackup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sistema_Solar_Interfacebackup().setVisible(true);
            }
        });
    }
